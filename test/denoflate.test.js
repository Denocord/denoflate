...
import Decompressor, { _setDevRelease, getDecompressor } from "../mod.ts";
...
const DISCORD_HELLO_DECOMPRESSED =
  '{"t":null,"s":null,"op":10,"d":{"heartbeat_interval":41250,"_trace":["[\\"gateway-prd-main-sfkf\\",{\\"micros\\":0.0}]"]}}';
...
Deno.test({
  ...
  fn() {
    ...
    assert.assertStrictEquals(
      td.decode(decompressor.res),
      DISCORD_HELLO_DECOMPRESSED,
      "Possibly corrupted data returned",
    );
  },
});
